<%@ page language="C#" autoeventwireup="true" codefile="TreeConfig.aspx.cs" inherits="TreeConfig" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="../css/TreeConfig.css?v=13" type="text/css" />
 <link rel="stylesheet" href="../css/TreeConfig.css?v=13" type="text/css" />
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed">
            ...
            <div class="row g-xl-8" id="overalldiv">
                ...
                <div class="col-xl-6 col-md-6 d-flex flex-column flex-column-fluid vh-100 min-vh-100" id="corporatediv">
                    ...
                    <div class="toolbar m-0 p-0 py-1">
                        <div class=" d-flex flex-stack flex-wrap flex-sm-nowrap p-0">
                            ...
                            <div class="d-flex pe-6 my-1">
                                ...
                                <a href="#" onclick="$('.searchBoxChildContainer.treeSearch').removeClass('d-none');$('#treeSearch').focus();"
                                ...
                                <button data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-dismiss="click" data-bs-original-title="Maximize Tree" class="btn btn-round btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm me-2 tb-btn btn-sm" id="maximizeTree" onclick="maximizeTree();">
                                    <i
                                        class="fa fa-expand-arrows-alt  btn-text-primary "></i>
                                </button>
                                ...
                                <button data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-dismiss="click" data-bs-original-title="Minimize Tree" class="btn btn-round btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm me-2 tb-btn btn-sm" style="display: none;" id="minimizeTree" onclick="minimizeTree();">
                                    <i
                                        class="fa fa-compress-arrows-alt  btn-text-primary "></i>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tree-footer mt-2">
                        <a href="#" class="btn btn-primary btn-sm me-2" onclick="publishTreeData();">Publish</a>
                        <a href="#"
                            class="btn btn-white btn-color-gray-700 btn-active-primary align-items-center shadow-sm me-2 btn-sm"  onclick="discardTreeData();">Discard</a>
                    </div>
                    <!--end::Table Widget 1-->
                ...
                <div class="col-xl-6  col-md-6 d-flex flex-column flex-column-fluid vh-100 min-vh-100" id="dimesiondiv">
                    ...
                    <div class="toolbar m-0 p-0 py-1">
                        <div class=" d-flex flex-stack flex-wrap flex-sm-nowrap p-0">
                            ...
                            <h1 class="text-dark fw-bolder my-1 fs-4 page-caption" id="dimensionCaption" onclick="closeDimension()">Dimensions</h1>

                            <div class="d-flex pe-6 my-1">

                                <a href="#" id="" onclick=""
                                    class="btn invisible btn-round btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm me-2 tb-btn btn-sm ">
                    ...
                    <!--end::List Widget 3-->
                    <iframe class="d-none" style="height: calc(100% - 0px);width: calc(100% - 0px);" id="dimensionIframe"></iframe>
    ...
    <script src="../js/TreeConfig.js?v=41"></script>
