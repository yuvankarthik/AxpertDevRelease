...
class BSModal { 
    ...
    */
    constructor(id, title, html, shownCallBack = ()=>{}, hideCallback = ()=>{}) {
        ...
        pElem.addEventListener("shown.bs.modal", ()=>{

          shownCallBack && shownCallBack()
        });
        pElem.addEventListener("hide.bs.modal", ()=>{hideCallback && hideCallback()});

        pElem.addEventListener("hidden.bs.modal", ()=>{pElem.remove()});

        pElem.addEventListener("close", ()=>{this.close()});
