...
function addTheValuesToGrid(dcNo, elem, trIndexForEdit, onlySave) {
    ...
    // var editDeleteOpts = "<td " + (gridColOptVisibility("uniqueEditDeleteAct", dcNo) || IsTabDc(dcNo) ? "" : "style=\"display:none;\"") + "><a class=\"btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm gridEditDeleteBtns\" onclick='editTheRow(this," + dcNo + ",\"" + GetFieldsRowNo(rowId) + "\",event);' title=\"Edit\"><span class=\"material-icons material-icons-style material-icons-3\">add</span></a>";
    // if (deleteRowExists)
    //     editDeleteOpts += "<a class=\"btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm gridEditDeleteBtns\" onclick='DeleteRow(" + dcNo + ", \"" + GetFieldsRowNo(rowId) + 'F' + dcNo + "\",this)' title=\"Delete\"><span class=\"material-icons material-icons-style material-icons-3\">delete</span></a>";
    // editDeleteOpts += "</td>";
    var editDeleteOpts = "<td class=\"text-center\"><span class=\"tem1\"><div class=\"form-check form-check-sm form-check-custom ms-2\"><input class=\"form-check-input fgChk gridRowChk\" type=\"checkbox\" name=\"grdchkItemTd" + dcNo + "\" id=\"grdchkItemTd" + GetFieldsRowNo(rowId) + "F" + dcNo + "\" onclick=\"javascript:CheckboxGridRow(this," + dcNo + "," + GetFieldsRowNo(rowId) + ",event);\"></div></span></td>";
    ...
    if (trIndexForEdit == undefined || trIndexForEdit === "") {
        ...
        var slNoHtml = '<td ' + ($("#uniqueThHead" + dcNo).is(":visible") || IsTabDc(dcNo) ? "" : "style=\"display:none;\"") + '><label id="lblSlNo' + GetFieldsRowNo(rowId) + 'F' + dcNo + '" class="form-control w-100 border-0 overflow-hidden resize-none slno">' + (trIndexForEdit + 1) + '</label></td>';
...
function createInpLabel(id, text, valueOfField, typeOfField, isFieldVisible, hiddenData, maxlength, inlineStyle, disableClass, calledFrom, displayClasses) {
    ...
    if (typeOfField == 'gridattach') {
        ...
        if (!id.toLowerCase().startsWith("axpfile_"))
            labelHtml += "<textarea style='display:none;' tabindex='-1' class='form-control w-100 border-0 overflow-hidden resize-none labelInp " + disableClass + "' maxlength='" + maxlength + "'  data-style='" + inlineStyle + "'  data-type='" + typeOfField + "' data-hidden='" + hiddenData + "' id='" + (axInlineGridEdit ? "grdA" : "") + id + "'  readonly>" + valueOfField + "</textarea>";
        else
            labelHtml += "<textarea style='display:none;' tabindex='-1' class='form-control w-100 border-0 overflow-hidden resize-none axpAttach labelInp " + disableClass + "' maxlength='" + maxlength + "'  data-style='" + inlineStyle + "'  data-type='" + typeOfField + "' data-hidden='" + hiddenData + "' id='" + id + "'  readonly>" + valueOfField + "</textarea>";
        if (axInlineGridEdit || (!axInlineGridEdit && AxpGridForm != "form")) { // if grid edit mode is inline edit then display upload icon for an attachment field
            ...
            if (!id.toLowerCase().startsWith("axpfile_")) {
                ...
                labelHtml += '<div class="form-group form-control p-0 grdattch" id="GridAttach' + fldName + endIdPart + '"><div id="dropzone_' + fldName + endIdPart + '" class="dropzone dropzone-queue min-h-1px border-0 px-3 py-2 dropzoneGrid"><div class="d-flex flex-row-auto flex-center dropzone-panel mb-lg-0 m-0"><a id="' + fldName + endIdPart + '" class="dropzone-select fs-7 gridattach"><span class="material-icons material-icons-style material-icons-2 float-start mx-2">upload_file</span> Drop files here or click to upload</a><span class="material-icons material-icons-style material-icons-2 float-end ms-4 fileuploadmore d-none" data-bs-toggle="popover" data-bs-sanitize="false" data-bs-placement="bottom" data-bs-html="true">more</span><a class="dropzone-remove-all btn btn-sm btn-light-primary d-none">Remove All</a></div><div class="dropzone-items wm-200px d-none"><div class="dropzone-item" style="display: none"><div class="dropzone-file overflow-hidden"><div class="dropzone-filename" title="some_image_file_name.jpg"><span data-dz-name>some_image_file_name.jpg</span></div><div class="dropzone-error" data-dz-errormessage></div></div><div class="dropzone-progress d-none"><div class="progress"><div class="progress-bar bg-primary" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" data-dz-uploadprogress></div></div></div><div class="dropzone-toolbar"><span class="dropzone-delete" data-dz-remove><span class="material-icons material-icons-style material-icons-2 float-end dropzoneGridItemDelete">clear</span></span></div></div></div></div></div>';
            } else {
                labelHtml += '<div class="form-group form-control p-0 grdattch" id="GridAxpFile' + fldName + endIdPart + '"><div id="dropzone_' + fldName + endIdPart + '" class="dropzone dropzone-queue min-h-1px border-0 px-3 py-2"><div class="d-flex flex-row-auto flex-center dropzone-panel mb-lg-0 m-0"><a id="' + fldName + endIdPart + '" class="dropzone-select fs-7 gridattach"><span class="material-icons material-icons-style material-icons-2 float-start mx-2">upload_file</span> Drop files here or click to upload</a><span class="material-icons material-icons-style material-icons-2 float-end ms-4 fileuploadmore d-none" data-bs-toggle="popover" data-bs-sanitize="false" data-bs-placement="bottom" data-bs-html="true">more</span><a class="dropzone-remove-all btn btn-sm btn-light-primary d-none">Remove All</a></div><div class="dropzone-items wm-200px d-none"><div class="dropzone-item" style="display: none"><div class="dropzone-file overflow-hidden"><div class="dropzone-filename" title="some_image_file_name.jpg"><span data-dz-name>some_image_file_name.jpg</span></div><div class="dropzone-error" data-dz-errormessage></div></div><div class="dropzone-progress d-none"><div class="progress"><div class="progress-bar bg-primary" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" data-dz-uploadprogress></div></div></div><div class="dropzone-toolbar"><span class="dropzone-delete" data-dz-remove><span class="material-icons material-icons-style material-icons-2 float-end dropzoneItemDelete">clear</span></span></div></div></div></div></div>';
            }
        ...
        labelHtml += "<textarea tabindex='-1' style='display:none;' class='form-control w-100 border-0 overflow-hidden resize-none labelInp " + disableClass + "' maxlength='" + maxlength + "'  data-style='" + inlineStyle + "' data-type='" + typeOfField + "' data-hidden='" + hiddenData + "' id='txt_axpBtn_" + id + "'  readonly>" + valueOfField + "</textarea>";
        ...
        labelHtml += "<textarea tabindex='-1' style='display:none;' class='form-control w-100 border-0 overflow-hidden resize-none labelInp " + disableClass + "' maxlength='" + maxlength + "'  data-style='" + inlineStyle + "' data-type='" + typeOfField + "' data-hidden='" + hiddenData + "' id='txt_axpBtnCustom_" + id + "'  readonly>" + valueOfField + "</textarea>";
    } else if (typeOfField == 'select') {
        var valOfTextField = "";
        valueOfField == "" ? valOfTextField = "" : valOfTextField = text;
        labelHtml += "<textarea tabindex='-1' class='form-control w-100 border-0 overflow-hidden resize-none selectTextArea labelInp " + disableClass + "' maxlength='" + maxlength + "'  data-style='" + inlineStyle + "' data-type='" + typeOfField + "' data-hidden='" + hiddenData + "' id='txtA~" + id + "'  readonly>" + valOfTextField + "</textarea>";
        ...
        labelHtml += "<textarea tabindex='-1' class='form-control w-100 border-0 overflow-hidden resize-none labelInp " + disableClass + "' maxlength='" + maxlength + "' style='" + inlineStyle + "' data-style='" + inlineStyle + "' data-type='" + typeOfField + "' data-hidden='" + hiddenData + "' id='" + id + "'  readonly>" + valueOfField + "</textarea>";
        ...
        valueOfField == "" ? valOfTextField = "" : valOfTextField = text;
        labelHtml += "<textarea tabindex='-1' class='form-control w-100 border-0 overflow-hidden resize-none selectTextArea labelInp " + disableClass + "' maxlength='" + maxlength + "'  data-style='" + inlineStyle + "' data-type='" + typeOfFields + isrefreshsave + "' data-hidden='" + hiddenData + "' id='" + id + "'  readonly>" + valOfTextField + "</textarea>";
        ...
        labelHtml += "<textarea tabindex='-1' class='form-control w-100 border-0 overflow-hidden resize-none selectTextArea labelInp " + disableClass + "' maxlength='" + maxlength + "'  data-style='" + inlineStyle + "' data-type='" + typeOfFields + isrefreshsave + "' data-sep='" + mgsSep + "' data-hidden='" + hiddenData + "' id='" + id + "'  readonly>" + valOfTextField + "</textarea>";
    } else {
        labelHtml += "<textarea tabindex='-1' class='form-control w-100 border-0 overflow-hidden resize-none labelInp " + disableClass + "' maxlength='" + maxlength + "'  data-style='" + inlineStyle + "' data-type='" + typeOfField + "' data-hidden='" + hiddenData + "' id='" + id + "'  readonly>" + valueOfField + "</textarea>";
    }
        ...
        if (currentElement[0].id.substr(currentElement[0].id.lastIndexOf("F") - 3, 3) != curRowNo && !currentElement[0].id.toLowerCase().startsWith("gridaxpfile_hlnk_")) {
            if (currentElement.hasClass('grdAttach')) {
                ...
                if (!fieldId.toLowerCase().startsWith("axpfile_")) {
                    ...
                    //gridHtml += '</div>';
                    gridHtml += '<div class="form-group form-control p-0 grdattch" id="GridAttach' + fieldId + lastPartOfId + '"><div id="dropzone_' + fieldId + lastPartOfId + '" class="dropzone dropzone-queue min-h-1px border-0 px-3 py-2 dropzoneGrid"><div class="d-flex flex-row-auto flex-center dropzone-panel mb-lg-0 m-0"><a id="' + fieldId + lastPartOfId + '" class="dropzone-select fs-7 gridattach"><span class="material-icons material-icons-style material-icons-2 float-start mx-2">upload_file</span> Drop files here or click to upload</a><span class="material-icons material-icons-style material-icons-2 float-end ms-4 fileuploadmore d-none" data-bs-toggle="popover" data-bs-sanitize="false" data-bs-placement="bottom" data-bs-html="true">more</span><a class="dropzone-remove-all btn btn-sm btn-light-primary d-none">Remove All</a></div><div class="dropzone-items wm-200px d-none"><div class="dropzone-item" style="display: none"><div class="dropzone-file overflow-hidden"><div class="dropzone-filename" title="some_image_file_name.jpg"><span data-dz-name>some_image_file_name.jpg</span></div><div class="dropzone-error" data-dz-errormessage></div></div><div class="dropzone-progress d-none"><div class="progress"><div class="progress-bar bg-primary" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" data-dz-uploadprogress></div></div></div><div class="dropzone-toolbar"><span class="dropzone-delete" data-dz-remove><span class="material-icons material-icons-style material-icons-2 float-end dropzoneGridItemDelete">clear</span></span></div></div></div></div></div>';
                } else {
                    gridHtml += '<div class="form-group form-control p-0 grdattch" id="GridAxpFile' + fieldId + lastPartOfId + '"><div id="dropzone_' + fieldId + lastPartOfId + '" class="dropzone dropzone-queue min-h-1px border-0 px-3 py-2"><div class="d-flex flex-row-auto flex-center dropzone-panel mb-lg-0 m-0"><a id="' + fieldId + lastPartOfId + '" class="dropzone-select fs-7 gridattach"><span class="material-icons material-icons-style material-icons-2 float-start mx-2">upload_file</span> Drop files here or click to upload</a><span class="material-icons material-icons-style material-icons-2 float-end ms-4 fileuploadmore d-none" data-bs-toggle="popover" data-bs-sanitize="false" data-bs-placement="bottom" data-bs-html="true">more</span><a class="dropzone-remove-all btn btn-sm btn-light-primary d-none">Remove All</a></div><div class="dropzone-items wm-200px d-none"><div class="dropzone-item" style="display: none"><div class="dropzone-file overflow-hidden"><div class="dropzone-filename" title="some_image_file_name.jpg"><span data-dz-name>some_image_file_name.jpg</span></div><div class="dropzone-error" data-dz-errormessage></div></div><div class="dropzone-progress d-none"><div class="progress"><div class="progress-bar bg-primary" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" data-dz-uploadprogress></div></div></div><div class="dropzone-toolbar"><span class="dropzone-delete" data-dz-remove><span class="material-icons material-icons-style material-icons-2 float-end dropzoneItemDelete">clear</span></span></div></div></div></div></div>';
                }
                ...
                if (typeOfField != undefined && typeOfField != "undefined") {
                    ...
                    if (typeOfField == "hidden") {
                        ...
                        if (idOFtheField.indexOf("axptm_", 0) === 0 || idOFtheField.indexOf("axpdbtm_", 0) === 0 || (fldDType != "" && fldDType.toLowerCase() == "time")) {
                            ...
                            editHtml += `<div class="divBarQrScan"><span class="material-icons">center_focus_weak</span></div>`;
                        }
...
function AddNewRowInDc(dcNo, calledFrom) {
    ...
    // var editDeleteOpts = "<td " + (gridColOptVisibility("uniqueEditDeleteAct", dcNo) || IsTabDc(dcNo) ? "" : "style=\"display:none;\"") + "><a class=\"btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm gridEditDeleteBtns\" onclick='editTheRow(this," + dcNo + ",\"" + strRowNo + "\",event);' title=\"Edit\"><span class=\"material-icons material-icons-style material-icons-3\">edit</span></a>";
    // if (deleteRowExists)
    //     editDeleteOpts += "<a class=\"btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm gridEditDeleteBtns\" onclick='DeleteRow(" + dcNo + ", \"" + endIdPart + "\",this)' title=\"Delete\"><span class=\"material-icons material-icons-style material-icons-3\">delete</span></a>";
    // editDeleteOpts += "</td>";

    var editDeleteOpts = "<td class=\"text-center\"><span class=\"tem1\"><div class=\"form-check form-check-sm form-check-custom ms-2\"><input class=\"form-check-input fgChk gridRowChk\" type=\"checkbox\" name=\"grdchkItemTd" + dcNo + "\" id=\"grdchkItemTd" + strRowNo + "F" + dcNo + "\" onclick=\"javascript:CheckboxGridRow(this," + dcNo + "," + strRowNo + ",event);\"></div></span></td>";

    var deleteHtml = "<td style='display:none;'>" + deleteRowHtml + "</td>";
    var slNoHtml = '<td ' + (gridColOptVisibility("uniqueThHead", dcNo) == false ? "style=\"display:none;\"" : (gridColOptVisibility("uniqueThHead", dcNo) || IsTabDc(dcNo)) ? "" : "style=\"display:none;\"") + '><label id="lblSlNo' + GetRowNoHelper(i) + 'F' + dcNo + '" class="form-control w-100 border-0 overflow-hidden resize-none slno">' + i + '</label></td>';
...
if (isMobile ) { //&& strRowNo != "001") {
    gridHtml += "<div id=\"dcCaptionBtn" + dcNo + "-" + strRowNo + "\" class=\"d-flex gap-3 frameCap dcCaptionBtn\"><span class=\"d-flex flex-center\">" + mobileDcCapt + "</span>" + mobileDcRowNo + "</div><hr class=\"text-gray-500\" />";
}
...
function addTheValuesToFormGrid(dcNo, rowNo, elem, trIndexForEdit, onlySave) {
    ...
    // var editDeleteOpts = "<td " + (gridColOptVisibility("uniqueEditDeleteAct", dcNo) || IsTabDc(dcNo) ? "" : "style=\"display:none;\"") + "><a class=\"btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm gridEditDeleteBtns\" onclick='editTheRow(this," + dcNo + ",\"" + GetFieldsRowNo(rowId) + "\",event);' title=\"Edit\"><span class=\"material-icons material-icons-style material-icons-3\">edit</span></a>";
    // if (deleteRowExists)
    //     editDeleteOpts += "<a class=\"btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm gridEditDeleteBtns\" onclick='DeleteRow(" + dcNo + ", \"" + GetFieldsRowNo(rowId) + 'F' + dcNo + "\",this)' title=\"Delete\"><span class=\"material-icons material-icons-style material-icons-3\">delete</span></a>";
    // editDeleteOpts += "</td>";
    ...
    if (trIndexForEdit == undefined || trIndexForEdit === "") {
        ...
        $j(".wrapperForGridData" + dcNo + " tbody tr.inEditMode").removeClass('inEditMode');
        var slNoHtml = '<td ' + (gridColOptVisibility("uniqueThHead", dcNo) == false ? "style=\"display:none;\"" : (gridColOptVisibility("uniqueThHead", dcNo) || IsTabDc(dcNo)) ? "" : "style=\"display:none;\"") + '><label id="lblSlNo' + GetFieldsRowNo(rowId) + 'F' + dcNo + '" class="form-control w-100 border-0 overflow-hidden resize-none slno">' + (trIndexForEdit + 1) + '</label></td>';
        $j(".wrapperForGridData" + dcNo + " tbody tr").eq(trIndexForEdit).html(editDeleteOpts + deleteHtml + slNoHtml + tableHtml);
...
------------------------------------
*/
function inlineGridEdit(dcNo, td, col, row) {
    try {
        ...
        if (parentTrElement != "") {
                ...
                if (index == 0) {
                    ...
                    if (typeOfField != undefined && typeOfField != "undefined") {
                        ...
                        if (typeOfField == "hidden") {
                            ...
                            if (isFieldDisable) {
                                editorHtml += '<input disabled type="text" id="' + idOFtheField + '" title="" name="' + idOFtheField + '" value="' + valueOfField + '" maxlength="' + maxlength + '" class="tem inputClass2 pixelwidth form-control flddis focus-input" style="' + inlineStyle + '">';
                            } else {
                            ...
                            if (idOFtheField.indexOf("axptm_", 0) === 0 || idOFtheField.indexOf("axpdbtm_", 0) === 0 || (fldDType != "" && fldDType.toLowerCase() == "time")) {
                                ...
                                editorHtml += `<div class="divBarQrScan"><span class="material-icons">center_focus_weak</span></div>`;
                            }
                            typeOfField == "numeric" ? classes = "tem form-control  Family number" : classes = axpfilePath + "tem form-control  Family " + timepicker;
                            if (timepicker != "")
                            ...
                            if (isFieldDisable) {
                                editorHtml += '<input disabled id="' + idOFtheField + '" name="' + idOFtheField + '" title="" value="' + valueOfField + '" maxlength="' + maxlength + '"  class="focus-input ' + classes + ' flddis" style="' + inlineStyle + '" type="text">';
                            } else {
                            ...
                            editorHtml += '<span class="input-group">';
                            if (isFieldDisable) {
                                editorHtml += '<input disabled id="' + idOFtheField + '" name="' + idOFtheField + '" title="" value="' + valueOfField + '" maxlength="' + maxlength + '" class="tem Family form-control date flatpickr-input  flddis focus-input" style="' + inlineStyle + '" type="text">';
                            } else {
                            ...
                            if (isFieldDisable) {
                                editorHtml += '<select disabled id="' + idOfSelectField + '" class="form-control flddis focus-input" style="display: inline-block !important">';
                            } else {
                            ...
                            editorHtml += '<input id="' + idOFtheField + '" name="' + idOFtheField + '" title="" alt="' + presentLabel.data('hidden') + '" value="' + valueOfField + '" class="gridchk Family focus-input" style="' + inlineStyle + '" type="checkbox"';
                            if (isFieldDisable) editorHtml += ' disabled readonly ';
                            if (valueOfField.toLowerCase() == 'yes') editorHtml += ' checked="checked" ';
                            editorHtml += ' ></input>'
                            editorHtml += '<span class="gridChkSpan">' + fldCaption + '</span></label>';
                            editorHtml += '</div>';
                        } else if (typeOfField == "textarea") {
                            if (isFieldDisable) {
                                editorHtml += '<textarea rows="2"  id="' + idOFtheField + '" name="' + idOFtheField + '" title="" disabled readonly maxlength="' + maxlength + '" class="tem form-control Family disabled focus-input" data-txt-area="true" style="' + inlineStyle + '" >' + valueOfField + '</textarea>';
                            } else {
                            ...
                            if (isFieldDisable) {
                                if (typeOfField == "fromselect-pick")
                                    editorHtml += '<select disabled class="tem fldFromSelect form-control focus-input form-select ' + auRefreshOnSave + '" data-control="select2" id="' + idOFtheField + '" data-placeholder="Select an option" data-allow-clear="true" data-refresh="false">';
                                else
                                    editorHtml += '<select disabled class="tem fldFromSelect form-control focus-input form-select fastdll ' + auRefreshOnSave + '" data-control="select2" id="' + idOFtheField + '" data-placeholder="Select an option" data-allow-clear="true" data-refresh="true">';
                            } else {
                                if (typeOfField == "fromselect-pick")
                                    editorHtml += '<select class="tem fldFromSelect form-control focus-input form-select ' + auRefreshOnSave + '" data-control="select2" id="' + idOFtheField + '" data-placeholder="Select an option" data-allow-clear="true" data-refresh="false">';
                                else
                                    editorHtml += '<select class="tem fldFromSelect form-control focus-input form-select fastdll ' + auRefreshOnSave + '" data-control="select2" id="' + idOFtheField + '" data-placeholder="Select an option" data-allow-clear="true" data-refresh="true">';
                            }
                            if (valueOfField != ""){
            ...
            CheckShowHideFldsGrid(dcNo); //to show/hide grid fields on click of edit
...
function updateInlineGridRowValues() {
    try {
        ...
        $(".inline-edit").closest("table").find("th .allowempty").closest("th").each(function () {
            if (grdRowValid) {
...
function addNewInlineGridRow(dcNo, calledFrom) {
    try {
        ...
        var tableHtml = createGridHtmlFromEdit(dcNo);
        // var editDeleteOpts = "<td " + (gridColOptVisibility("uniqueEditDeleteAct", dcNo) ? "" : "style=\"display:none;\"") + "><a class=\"btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm gridEditDeleteBtns\" onclick='editTheRow(this," + dcNo + ",\"" + GetFieldsRowNo(rowId) + "\",event);' title=\"Edit\"><span class='material-icons material-icons-style material-icons-3" + (gridDummyRows == true ? "'" : (calledFrom === "LoadData" || calledFrom === "GetDep" ? "'" : " disabled' disabled='disabled''")) + ">edit</span></a>";
        // if (deleteRowExists)
        //     editDeleteOpts += "<a class=\"btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm gridEditDeleteBtns " + (gridDummyRows == true ? "disabled' disabled='disabled'" : "'") + "\" onclick='DeleteRow(" + dcNo + ", \"" + GetFieldsRowNo(rowId) + 'F' + dcNo + "\",this)' title=\"Delete\"><span class=\"material-icons material-icons-style material-icons-3\">delete</span></a>";
        // editDeleteOpts += "</td>";
...
function validateInlineGridRow(dcNo, calledfrom) {
    ...
    if (invalidDataRows.length > 0) {
        $("[inline-grid-warning]").removeAttr("inline-grid-warning")
        var mandatoryFields = invalidDataRows.first().find("[data-fld-mandatory]");
        if (mandatoryFields.length > 0) {
            ...
            if ((fType == "Numeric" && parseFloat(fldValue) == 0 || fldValue === "")) {
...
function viewGridPopUp(gridDcNum) {
    let gridTableHTML = `<div class="dcTablePopup"><table class="customSetupTableMN gridHeader table">` + $("#colScroll" + gridDcNum + " table").html() + `</table></div>`;
