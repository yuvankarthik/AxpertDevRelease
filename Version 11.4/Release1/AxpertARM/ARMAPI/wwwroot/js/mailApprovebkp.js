    ...
    constructor() {
        ...
        <div class="task-actions-sets d-flex" data-taskname="{{taskname}}" data-processname="{{processname}}">
            ...
            <a href="javascript:void(0)" title="Approve"
                class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  btn-sm  me-2 approvebtn "
                onclick="axTasksObj.doApprove('{{taskid}}', this);" data-confirmMessage='{{cmsg_appcheck}}'><span class="material-icons material-icons-style material-icons-2"
                    style="color: #fff;">check_circle</span> Approve
            </a>
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm approvebtn" onclick="return axTasksObj.doApprove('{{taskid}}', this);" data-confirmMessage='{{cmsg_appcheck}}'>Approve</button>
                        </div>
                    </div>
                </div>
            </div>
...
`;
        ...
        <div class="task-actions-sets d-flex" data-taskname="{{taskname}}" data-processname="{{processname}}">
            <a href="javascript:void(0)" title="Reject"
                class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  me-2  btn-sm rejectBtn"
                onclick="axTasksObj.doReject('{{taskid}}', this)" data-confirmMessage='{{cmsg_reject}}'><span class="material-icons material-icons-style material-icons-2"
                    style="color: white;">cancel</span>Reject</a>
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bolder w-400px Active_list_popover"
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm rejectBtn" data-confirmMessage='{{cmsg_reject}}' onclick="return axTasksObj.doReject('{{taskid}}', this)">Reject</button>
                        </div>
                    </div>
                </div>
            </div>
...
`;
        ...
        <div class="task-actions-sets d-flex" data-taskname="{{taskname}}" data-processname="{{processname}}">
            <a href="javascript:void(0)" title="Return"
                class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  me-2  btn-sm returnBtn"
                onclick="axTasksObj.doReturn('{{taskid}}', this, '{{tasktype}}')" data-confirmMessage='{{cmsg_return}}'><span class="material-icons material-icons-style material-icons-2"
                    style="color: white;">reply</span>Return</a>
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bolder w-400px Active_list_popover"
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm returnBtn" data-confirmMessage='{{cmsg_return}}' onclick="return axTasksObj.doReturn('{{taskid}}', this, '{{tasktype}}')">Return</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
            <a href="javascript:void(0)" href="javascript:void(0)" title="Approve" data-confirmMessage='{{cmsg_appcheck}}' onclick="axTasksObj.doApprove('{{taskid}}', this);" class="mobile approvebtn">
                <span class="material-icons material-icons-style material-icons-2" style="color: #fff;">
                    <span class="material-symbols-outlined">
                        check_circle
                    </span>
                </span><span class="TA-name">Approve</span>
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bolder w-400px Active_list_popover"
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm mobile approvebtn"
        ...
        <li>
            <a href="javascript:void(0)" href="javascript:void(0)" title="Reject" data-confirmMessage='{{cmsg_reject}}' onclick="axTasksObj.doReject('{{taskid}}', this);" class="mobile rejectBtn">
                <span class="material-icons material-icons-style material-icons-2" style="color: white;">
                    <span class="material-symbols-outlined">
                        cancel
                    </span>
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Reject-OK">
                            <button class="btn btn-sm btn-primary shadow-sm mobile rejectBtn" data-confirmMessage='{{cmsg_reject}}'
        ...
        <li>
            <a href="javascript:void(0)" href="javascript:void(0)" title="Return" data-confirmMessage='{{cmsg_return}}' onclick="axTasksObj.doReturn('{{taskid}}', this, '{{tasktype}}');" class="mobile returnBtn">
                <span class="material-icons material-icons-style material-icons-2" style="color: white;">
                    <span class="material-symbols-outlined">
                        reply
                    </span>
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Return-OK">
                            <button class="btn btn-sm btn-primary shadow-sm mobile returnBtn" data-confirmMessage='{{cmsg_return}}'
    ...
    openPassWordWindow(id, url, size) {
        var urlActionText = urlTaskAction.toUpperCase();
        if (urlActionText === 'APPROVE') {
            urlActionText = 'Approve'
        } else if (urlActionText === 'REJECT') {
            urlActionText = 'Reject'
        } else {
            urlActionText = 'Return'
        }
        let modalObj = {};
        modalObj.id = id;
        modalObj.url = url;
        modalObj.iFrameModalBody = `<div class='d-flex justify-content-center model-content'><span id='defalutText'class='defalutText'>Please enter your password to proceed</span></div><div class="d-flex justify-content-start input-icon left mx-8"><input id="passwordfield" class="m-wrap placeholder-no-fix form-control form-control-solid" tabindex="1" type="password" autocomplete="off" placeholder="Password" name="" title="Password" required=""></div></div><div class="d-flex justify-content-end input-icon left"><a href="javascript:void(0)" class="btn btn-sm btn-primary mb-5 VerifyBtn" onclick='axTasksObj.passwordbindevent()' id="passwordVerifyBtn">${urlActionText}</a></div>`
            ...
            try {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        let callApidata = { ARMSessionId: armSessionId, TaskId: callApiTaskId, TaskType: callApiTaskType, Action: callApiaction, StatusReason: callApiTaskReason, StatusText: callApiTaskText };
    ...
    doTaskAction(action, taskId, taskType, elem) {
        ...
        callApiTaskId = taskId;
        callApiTaskType = taskType;
        ...
        callApiTaskReason = taskReason;
        callApiTaskText = taskType;
        ...
        if (this.dataSources["Tasks"]?.length == undefined || this.dataSources["Tasks"].length == 0) {
            ...
            this.dataSources["Tasks"].forEach((rowData, idx) => {
                if (!this.isNullOrEmpty(rowData.taskstatus)) {
                    let htmlText = `<div class='d-flex p-5'><div class="d-flex  symbol symbol-50px">
                    <span class="symbol-label spanimg-background">
                    <img alt="{{processname}}" class=" w-30px" src="../../custompages/icons/{{processname}}.png"
                    onerror="this.onerror=null;this.src='../../custompages/icons/default.png';">
                    </span>
                    <span class='pt-5 px-5'>{{displaycontent}}</span></div>
                </div>
                    <div class='d-flex p-5 mx-5'><span class="material-icons material-icons-style material-icons-2"
                    ...
                    if (!this.isNullOrEmpty(rowData.statusreason)) {
                        htmlText += `<div class='d-flex p-5 mx-5'><span class="material-icons material-icons-style material-icons-2"
                ...
                switch (rowData.tasktype.toUpperCase()) {
                    ...
                    case "APPROVE":
                        ...
                        if (urlTaskAction.toUpperCase() === 'APPROVE') {
                            rowData.task_buttons_html = this.taskBtnsHtml.approve
                        }
                        else if (urlTaskAction.toUpperCase() === 'REJECT') {
                            rowData.task_buttons_html = this.taskBtnsHtml.reject
                        }
                        else if (urlTaskAction.toUpperCase() === 'RETURN') {
                            rowData.task_buttons_html = this.taskBtnsHtml.return
                        }
                        // + this.taskBtnsHtml.reject + (rowData?.returnable == 'T' ? this.taskBtnsHtml.return : "") + this.taskBtnsHtml.view + this.taskBtnsHtml.history;

                        if (urlTaskAction.toUpperCase() === 'APPROVE') {
                            rowData.mobile_task_buttons_html = this.mobileTaskButtons.approve
                        }
                        else if (urlTaskAction.toUpperCase() === 'REJECT') {
                            rowData.mobile_task_buttons_html = this.mobileTaskButtons.reject
                        }
                        else if (urlTaskAction.toUpperCase() === 'RETURN') {
                            rowData.mobile_task_buttons_html = this.mobileTaskButtons.return
                        }
