                        ...
                        if (comboField != undefined) {
                            ...
                            if (comboField.prop("type") == "select-one") {
                                ...
                                if (IsChkList) {
                                    ...
                                    fldClass = "type=radio class='form-control p-0 form-check-input h-40px w-40px opacity-100 multiFldRdg'";
                                }
...
function redirectOnSaveAction() {
    ...
    if (recIdVal == "" || recIdVal == "0") {
        GetProcessTime();
        window.location.href = "tstruct.aspx?act=load&transid=" + tst + axSplit + "&hdnbElapsTime=" + callParentNew("browserElapsTime");
    }
        ...
        if (AxIsTstructCached) {
            ...
            GetProcessTime();
            window.location.href = "tstruct.aspx?act=load&transid=" + tst + "&recordid=" + recIdVal + axSplit + "&hdnbElapsTime=" + callParentNew("browserElapsTime");
        }
    }
}
